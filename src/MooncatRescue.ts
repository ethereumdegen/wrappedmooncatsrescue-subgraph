...
import { WrappedMooncat, Account } from '../generated/schema'
...
export function handleMintWrappedMooncat(_: MintCall): void {
...
export function handleTransferWrappedMooncat(event: Transfer): void {
